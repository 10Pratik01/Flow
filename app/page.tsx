  ...
  return (
     <div className="relative w-full overflow-x-hidden bg-background flex flex-col min-h-screen">
      <section className="relative h-100 w-full flex flex-col overflow-hidden">
        <div className={` h-[120vh] w-full flex flex-col  overflow-hidden select-none bg-gray-500`} >
          ...
          <div className="flex flex-col h-209.5 w-full mx-5 my-2  ">
            ...
            transition={{ duration: 0.8 }}
             className= "mt-20 w-full pl-20 flex flex-col justify-center items-start ">
                  <h1 className="text-blue-300 text-[50px] w-full md:text-[90px] flex justify-center -translate-x-10 md:-translate-x-5 -mb-2.5 font-semibold">Milestone</h1>
                   <h1 className="text-blue-900 text-[50px] w-full md:text-[25px] flex justify-center -translate-x-10 md:-translate-x-5 -mb-2.5 font-semibold">Your personalized project management plactform</h1>
              </motion.div>
          </div>
        </div>
      </section>
...
<section className="relative w-full mb-10 md:mb-1  overflow-hidden">
  ...
  <div className="relative min-h-screen md:min-h-[120vh] lg:min-h-[140vh] flex items-center justify-center bg-white dark:bg-black px-4 md:px-10">
    ...
    {/* Content */}
    <div className="relative z-20 w-full max-w-7xl text-center mt-20">
